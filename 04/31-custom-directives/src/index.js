...
const server = new ApolloServer({
	...
	context: ({ req }) => {
		...
		return {
			user: { id: 1, firstName: 'Larry', token: 'TOKEN-LARRY', role: 'USER', customNDCHeader: req.headers.ndc },
			// user: { id: 2, firstName: 'Rita', token: 'RITA', role: 'USER', customNDCHeader: req.headers.ndc },
		};
	},
});
